...
const questions = [{
    ...
    {
        message: "\033[32mWhat is your Email address? -- : ",
        name: 'eMail',
        type: 'input',
    ...
    {
        message: "\033[32mWhat is your Project's name? -- : ",
        name: 'projectName',
        type: 'input',
    ...
    {
        message: "\033[32mShort description of your project -- : ",
    ...
    {
        message: "\033[32mWhat type of license your project have? -- : ",
    ...
    {
        message: "\033[32mWhat command should be used to install dependencies? -- : ",
        name: 'commandInstall',
        type: 'input',
        default: "npm install",
        transformer: (input) => {
    ...
    {
        message: "\033[32mWhat command should be run to run tests? -- : ",
        name: 'commandTest',
        type: 'input',
        default: "Console.log",
        transformer: (input) => {
    ...
    {
        message: "\033[32mWhat does the users need to know about this repo? -- : ",
        name: 'aboutRepo',
        type: 'input',
        transformer: (input) => {
            return `---> ${input} <---`
    ...
    {
        message: "\033[32mWhat does the user need to know about contributing to the repo? -- : ",
